...
import cn.david.zhumingwei.mylibrary.animation.ChartAnimationListener;
import cn.david.zhumingwei.mylibrary.animation.ChartDataAnimator;
import cn.david.zhumingwei.mylibrary.animation.ChartDataAnimatorV14;
import cn.david.zhumingwei.mylibrary.animation.ChartDataAnimatorV8;
import cn.david.zhumingwei.mylibrary.animation.ChartViewportAnimator;
import cn.david.zhumingwei.mylibrary.animation.ChartViewportAnimatorV14;
import cn.david.zhumingwei.mylibrary.animation.ChartViewportAnimatorV8;
import cn.david.zhumingwei.mylibrary.computator.ChartComputator;
import cn.david.zhumingwei.mylibrary.gesture.ChartTouchHandler;
...
import cn.david.zhumingwei.mylibrary.renderer.AxesRenderer;
import cn.david.zhumingwei.mylibrary.renderer.ChartRenderer;
...
public abstract class AbstractChartView extends View implements Chart {
    ...
    public void setZoomLevel(float x, float y, float zoomLevel) {
        Log.e("setZoomLevel","x="+x+":y="+y+":zoomLevel="+zoomLevel );
